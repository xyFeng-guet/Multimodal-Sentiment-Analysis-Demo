...
class MultiClass(nn.Module):
    def __init__(self, hp):
        ...
        dim_sum = hp.dim_seq_out_a + hp.dim_seq_out_v + hp.origin_dim_t
    ...
    def forward(self, batch_data):
        ...
        feature_text, feature_seq, lengths, mask, label = batch_data
        ...
        unimodal_info = torch.cat([feature_text[:, 0, :], sent_seq_a, sent_seq_v], dim=-1)
